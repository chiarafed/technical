		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "MFC app",
									"targetURL": "#projectMfcTechnicalprojectmfctechnical-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"projectMfcTechnicalprojectmfctechnical-display": {
								"semanticObject": "projectMfcTechnicalprojectmfctechnical",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=projectMfcTechnical.projectmfctechnical",
									"url": sap.ui.require.toUrl("projectMfcTechnical/projectmfctechnical")
								}
							}
						}
					}
